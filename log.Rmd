...
Logistic and bagging are tied for the highest accuracy, it might be worth it to try further experimentation with both of these algorithms.
...
```{r}
roc_data <- read.table("~/Desktop//Thema9/ROC.arff", sep = ",", comment.char = "@")
